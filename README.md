...
To Do:
- [X] Setup Project
- [X] Make temporary block for Computer (clone a bench?)
- [X] Make custom interaction
- [X] Start work on `LuaMachine` (for handling LuaJ, will be abstracted later)
- [X] Test and verify `LuaMachine` works via interaction
